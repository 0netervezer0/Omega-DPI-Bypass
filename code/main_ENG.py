# #######################
# LupiDPI ( Windows Edition ) V1.3.1 ( ENG )
# by Netervezer
# #######################
...
def main( page: Page ):
    ...
    def Start( e = None ):
        if AltStarts.value == 'Alt Laucnh 1':
            system('cd DPI & general (ALT1).bat')
        elif AltStarts.value == 'Alt Launch 2':
            system('cd DPI & general (ALT2).bat')
        elif AltStarts.value == 'Alt Launch 3':
            system('cd DPI & general (ALT3).bat')
        elif AltStarts.value == 'Alt Launch 4':
            system('cd DPI & general (ALT4).bat')
        elif AltStarts.value == 'Alt Launch 5':
    ...
    WarningLabel = Text(
        "You can close this wondows, but do not close the terminal!",
        color = '#C6C6C6',
        weight = FontWeight.BOLD
    )

    StopBTN = FilledButton(
        text = 'Stop DPI Bypass',
        width = 300,
        height = 40,
        style = ButtonStyle(
            bgcolor = '#33A3AD',
    ...
    AltStarts = Dropdown(
        ...
        height = 45,
        options = [
            dropdown.Option( 'Default Launch' ),
            dropdown.Option( 'Alt Laucnh 1' ),
            dropdown.Option( 'Alt Launch 2' ),
            dropdown.Option( 'Alt Launch 3' ),
            dropdown.Option( 'Alt Launch 4' ),
            dropdown.Option( 'Alt Launch 5' ),
        ]
    )
